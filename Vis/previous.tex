...
techniques. Techniques for data abstraction include filtering \lstopar{[TODO cite]}, clustering
...
The most common techniques for clutter reduction include zooming and distortion \cite{559215,1382895} \lstopar{[TODO cite zooming]}.
...
scatter plots, box plots, heatmaps, etc., to visualization of more complex structures such as \lstopar{dimensionality reduction \cite{Fortuna05visualizationof,Vesanto99som-baseddata}},
