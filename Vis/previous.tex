...
\subsubsection{\lstopar{Clustering-Based Visualization}}

\lstopar{

Visualization of clusters provides a convenient method for identifying and presenting dissimilarities in the data.

- PRoblem with techniques: most of them discard temporal information when visualizing time series data.
