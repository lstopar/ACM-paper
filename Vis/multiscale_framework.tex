...
\begin{figure*}[]
	...
	\caption{Overview of the proposed pipeline. (a) We first represent the multivariate time series as a point cloud, where each point in time, the values of the multiple time series are used as coordinates. Ignoring   }
