...
the data on several details level - from the finest to the most coerce.
...
partition function \lstopar{$f: \mathbb{R}^d \rightarrow I$} defined in Section \ref{sec:framework-states}, which induces
...
Thus $I_s$ represents a partition of $I$ and is used as the state space on scale $s$.
