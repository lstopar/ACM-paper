...
states based on the inner-state attribute distributions by concatenating the most outlying attribute with respect to other states with a discrete level, ranging from: lowest, low to high and highest. \primoz{this sentence isnt clear}
