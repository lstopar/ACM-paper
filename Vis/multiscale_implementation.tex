\begin{itemize}
	...
	\lstopar{
	K-Means objective function \cite{DBLP:journals/corr/abs-1111-0352} \ref{eq:k-means-objective}
	\begin{equation}
		\label{eq:k-means-objective}
		\min\limits_{\{c_i\}_{i \in \mathbb{N}_k}} \sum\limits_{i = i}^{k}\sum\limits_{x_j \in c_i} \|x_j - \mu_i\|
	\end{equation}
	}
