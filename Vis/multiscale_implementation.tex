...
% }
Finally, to visualize the Markov chain, we use multi-dimensional scaling (MDS) \cite{cox2000multidimensional} on the graph, \lstopar{using distances between the centroids of $I$. 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.5\columnwidth]{dendrogram-V2}
