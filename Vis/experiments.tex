...
We generated two datasets: a training set and a test set, both containing $200k$ observations. The model was computed with 20 initial states on the training set using two attributes: angular velocity and temperature. %Comparing the models' jump chain $\Pi$ and the . %The training dataset was then replayed and the initial states stored. We then used
...
\primoz{We have to say something else for this model - this doesnt make much sense as is.}
