...
\teaser{
	...
	\caption{
	On the move: yearly travels of a European researcher. A multi-scale summary of GPS coordinates collected over the course of four years using a smartphone. Our \lstopar{tool} summarizes the dataset in a qualitative manner using states and transitions and models them in a hierarchical manner, allowing users to traverse the hierarchy using the zoom function. From the visual summary we were able to identify the typical locations the person visited, including the USA, Germany, China, Italy and Slovenia.
	}
}
