...
\teaser{
  ...
  \label{fig:teaser}  
	...
	\lstopar{We show our model in a three panel user interface with the central panel showing our qualitative representation, the details panel on the right showing the structure of the selected state and a bottom panel showing an additional summary of the state.}
