...
\begin{itemize}
	...
	\item \lstopar{ACM Transactions on Interactive Intelligent Systems}
	\item \lstopar{ACM Transactions on Knowledge Discovery from Data}
	\item \lstopar{ACM Transactions on Computer-Human Interaction (TOCHI)}
	\item \lstopar{ACM Transactions on Modeling and Computer Simulation (TOMACS)}
\end{itemize}