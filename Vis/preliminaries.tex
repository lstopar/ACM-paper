...
Each row of $P(t)$ is thus a probability distribution over the state space $I$. In our work we assume $(X_t)_{t \ge 0}$ irreducible, non-explosive and has a finite number of states.
